...
myBarScrollLeft.addEventListener('click', ()=>{
    document.querySelector('.bar-products-cont').scrollLeft -= 1500
})
...
sl4.addEventListener('click', ()=>{
    bestFruitsCont.scrollLeft -= 1500
})
...
sl5.addEventListener('click', ()=>{
    bestFriendCont.scrollLeft -= 1500
})
